use crate::core::*;
use wasm_encoder::{BlockType, Instruction, RefType, ValType};
...
fn dummy_value_inst<'a>(ty: ValType) -> Instruction<'a> {
    match ty {
        ...
        ValType::Ref(_) => unimplemented!(), // TODO(dhil): FIXME
    }
}
...
fn size_of_type_in_memory(ty: ValType) -> u64 {
    match ty {
        ...
        ValType::F64 => 8,
        ValType::V128 => 16,
        ValType::FuncRef | ValType::ExternRef | ValType::Ref(_) => panic!("not a memory type"),
    }
}
